...
// import { createCheckoutSession } from "@/app/actions"; // Temporarily disabled for visual focus
...
export default function Home() {
  ...
  const handlePayClick = async () => {
    ...
    alert("Stripe integration is temporarily disabled for visual testing.");
    ...
    <main className="min-h-screen bg-[#050508] text-white overflow-hidden selection:bg-purple-500/30 font-sans">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <section className="min-h-[90vh] flex flex-col items-center justify-center text-center pt-10 pb-32">
          ...
          {/* Planet/Orb Graphic - Refined */}
          <div className="mt-20 relative w-[500px] h-[300px] md:w-[800px] md:h-[500px] pointer-events-none select-none">
            {/* Core Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] rounded-full bg-purple-600/20 blur-[100px]" />
            
            {/* Abstract Sphere/Grid - CSS representation */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[200px] rounded-full bg-gradient-to-b from-purple-500/10 to-transparent border border-white/5 shadow-[0_0_60px_rgba(168,85,247,0.15)] animate-pulse-slow backdrop-blur-sm" />
            
            {/* Orbital Rings */}
             <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[100px] rounded-[100%] border border-purple-500/10 rotate-12" />
             <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[100px] rounded-[100%] border border-purple-500/10 -rotate-12" />
          </div>
        </section>

        {/* How It Works - Refined Cards */}
